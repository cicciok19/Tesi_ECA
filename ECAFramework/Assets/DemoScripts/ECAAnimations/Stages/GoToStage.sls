...
:SLSConstructor.286331408{#4{8 9 "96612584"}
#1{2@0 @0 }
#1{2@0 @0 }
...
#4{0 1 ""}
@0  0 0 1
 1  1 #4{69 70 ": base(ecaAction, ecaAnimator)\n
\[\n
        Destination = destination;\n
\]"}
#4{11 12 "Constructor"}
#4{0 1 ""}
#4{71 72 "ECAAction ecaAction, ECAAnimatorDemo ecaAnimator, Transform destination"}
#4{0 1 ""}
}
