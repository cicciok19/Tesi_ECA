...
#4{0 1 ""}
@0  0 0 1
 0  0 #4{31 32 "public interface IIntentHandler"}
#4{0 7 ""}
#4{0 13 ""}
...
:SLSProtectMethod.286331408{#4{9 10 "103762488"}
#1{2@0 @0 }
#1{2@0 @0 }
@0  8 1 0.4 0 0 #4{31 32 "SubscribeHandlerToIntentManager"}
 1.3 0.88 12.4 19  7 #4{0 1 ""}
#4{0 1 ""}
@0  0 0 1
 1  1 #4{4 5 "\[\n
\]\n
...
#4{0 1 ""}
 0}
:SLSProtectProperty.286331392{#4{9 10 "103755824"}
#1{2@0 @0 }
#1{2@0 @0 }
